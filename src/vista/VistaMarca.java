...
public class VistaMarca extends javax.swing.JDialog {
     ...
     */
    public VistaMarca(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jtbMarcas.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VistaMarca dialog = new VistaMarca(new javax.swing.JFrame(), true);
